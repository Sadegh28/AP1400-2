...
function translateToPersian() {
    ...
    var a = document.getElementById('sl_3_number')
    a.innerText = `3`
    a.style.fontFamily = 'IranYekan'

    var a = document.getElementById('sl_3_subject')
    a.innerText = 'ساختار های کنترلی'
    a.style.fontFamily = 'IranYekan'
    ...
    var a = document.getElementById('session3_intro')
    a.innerText = 'ساختار های کنترلی (پی دی اف)'
    a.style.fontFamily = 'IranYekan'
...
function translateToEnglish() {
    ...
    a.classList.remove('persian')
    a.style.fontFamily = '"Roboto Serif"; 17px;'
    ...
    var s = document.getElementsByTagName('th');
    for (i = 0; i < s.length; i++) {
        s[i].style.fontFamily = 'Roboto Serif';
    }
    ...
    var a = document.getElementById('sl_3_subject')
    a.innerText = 'Control Structures'
    a.style.fontFamily = 'Roboto Serif'
    ...
    var a = document.getElementById('session3_intro')
    a.innerText = 'Control Structures (.pdf)'
    a.style.fontFamily = 'Roboto Serif'
